    ...
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-white shadow-[0_-2px_8px_rgba(0,0,0,0.06)] safe-area-bottom">
      <div className="max-w-[430px] mx-auto px-4 py-3 flex items-center gap-4">
        ...
        <div className="relative flex-shrink-0">
          <div className="w-[40px] h-[40px] rounded-full bg-[#D84315] flex items-center justify-center shadow-sm">
          ...
          <span
            key={cartCount}
            className="absolute -top-1.5 -right-1.5 bg-[#D84315] text-white text-[10px] font-bold min-w-[18px] h-[18px] rounded-full flex items-center justify-center px-1 shadow-sm animate-bounce-in"
          >
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[12px] text-[#9A9AAB] font-medium">{t('total') || 'Total'}</p>
          <p className="text-[17px] font-bold text-[#1A1A2E]">{t('app.currency')}{cartTotal.toLocaleString()}</p>
        </div>
